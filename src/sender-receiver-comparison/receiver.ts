...
const CONFIG = {
  ...
  mode: process.env.APPGATEWAY_MODE ?? "recv",
  token: process.env.APPGATEWAY_TOKEN ?? 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJVc2VySUQiOiIzNjY1NjAwMzgyIiwiUGxhdGZvcm1JRCI6NSwiZXhwIjoxNzgyMjA0ODU2LCJpYXQiOjE3NzQ0Mjg4NTF9.D4pQUxoU_ktxcnkAlcCcCx_ELjrr8yep4CttWy0c6Zo',
  recvID: process.env.APPGATEWAY_RECV_ID ?? '1998927317',
